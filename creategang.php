...
if (isset($_POST['submit']) && isset($_POST['name']) && isset($_POST['desc']) && !empty($_POST['name'])) {
	if (!isset($_POST['verf']) || !verify_csrf_code("creategang", stripslashes($_POST['verf']))) {
		echo '<h3>Error</h3><hr />
