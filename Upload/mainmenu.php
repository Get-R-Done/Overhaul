...
echo ($ec > 0) ? '<a href="events.php" style="font-weight: bold;">Events (' . $ec . ')</a><br />' : '<a href="events.php">Events (0)</a><br />';
echo ($mc > 0) ? '<a href="mailbox.php" style="font-weight: bold;">Mailbox (' . $mc . ')</a><br />' : '<a href="mailbox.php">Mailbox (0)</a><br />';
...
echo ($ir['new_announcements']) ? '<a href="announcements.php" style="font-weight: bold;">Announcements (' . $ir['new_announcements'] . ')</a><br />' : '<a href="announcements.php">Announcements (0)</a><br />';
echo "
...
if ($ir['user_level'] > 1) {
	...
	$q             = $db->query("SELECT `userid`, `username`, `laston`
                     FROM `users`
